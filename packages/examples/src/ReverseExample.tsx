...
// const generateArray = (size: number) => Array.from({ length: size }, (_, i) => i + 1);
...
//   const [result, run, terminate, worker, isRunning] = useWebWorker<number[] | { error: string }>(
...
//       <p>
//         This example uses <code>useWebWorker</code> to reverse a large array without blocking the
//         UI.
//       </p>
...
//           />
//         </label>
//         <button onClick={handleReset} style={{ marginLeft: '10px' }} disabled={isRunning}>
//           Reset Array
//         </button>
//       </div>
...
//         <p>
//           <strong>Note:</strong> Try clicking other buttons while the array is being reversed. The
